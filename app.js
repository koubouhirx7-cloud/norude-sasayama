document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ja: {
            ...
            "nav-access": "アクセス",
            "hero-title": "丹波篠山を、<br class='sp-br'>もっと自由に。",
            "hero-desc": "時間の制約も、場所の悩みも。",
            ...
            "usage-title": "ご利用の流れ",
            "usage-desc": "初めての方でも安心。4つのステップで<br class='sp-br'>簡単にご利用いただけます。",
            "step-1-title": "アプリ登録",
            ...
            "map-title": "シームレスな<br class='sp-br'>観光を。",
        ...
        en: {
            ...
            "nav-access": "Access",
            "hero-title": "Explore Tamba Sasayama, Freer.",
            "hero-desc": "Break free from time limits and location worries.",
    ...
    const stations = [
        ...
        },
        {
            ...
            heroImage: 'assets/station-sasayamaguchi.jpg',
